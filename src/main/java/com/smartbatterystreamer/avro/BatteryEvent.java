 ...
 */
package com.smartbatterystreamer.avro;
...
public class BatteryEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8420224068801635019L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"BatteryEvent\",\"namespace\":\"com.smartbatterystreamer.avro\",\"fields\":[{\"name\":\"uuid\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"arrival_time_ms\",\"type\":[\"long\",\"null\"]},{\"name\":\"body\",\"type\":[\"bytes\",\"null\"]}]}");
   ...
   */
  public BatteryEvent(java.lang.String uuid, java.lang.Long arrival_time_ms, java.nio.ByteBuffer body) {
    this.uuid = uuid;
   ...
   */
  public static com.smartbatterystreamer.avro.BatteryEvent.Builder newBuilder() {
    return new com.smartbatterystreamer.avro.BatteryEvent.Builder();
  }
   ...
   * @return A new BatteryEvent RecordBuilder
   */
  public static com.smartbatterystreamer.avro.BatteryEvent.Builder newBuilder(com.smartbatterystreamer.avro.BatteryEvent.Builder other) {
    if (other == null) {
      return new com.smartbatterystreamer.avro.BatteryEvent.Builder();
    } else {
      return new com.smartbatterystreamer.avro.BatteryEvent.Builder(other);
    }
  }
   ...
   * @return A new BatteryEvent RecordBuilder
   */
  public static com.smartbatterystreamer.avro.BatteryEvent.Builder newBuilder(com.smartbatterystreamer.avro.BatteryEvent other) {
    if (other == null) {
      return new com.smartbatterystreamer.avro.BatteryEvent.Builder();
    } else {
      return new com.smartbatterystreamer.avro.BatteryEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<BatteryEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.smartbatterystreamer.avro.BatteryEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.smartbatterystreamer.avro.BatteryEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.uuid)) {
        this.uuid = data().deepCopy(fields()[0].schema(), other.uuid);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.smartbatterystreamer.avro.BatteryEvent.Builder setUuid(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.smartbatterystreamer.avro.BatteryEvent.Builder clearUuid() {
      uuid = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.smartbatterystreamer.avro.BatteryEvent.Builder setArrivalTimeMs(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.smartbatterystreamer.avro.BatteryEvent.Builder clearArrivalTimeMs() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.smartbatterystreamer.avro.BatteryEvent.Builder setBody(java.nio.ByteBuffer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.smartbatterystreamer.avro.BatteryEvent.Builder clearBody() {
      body = null;
